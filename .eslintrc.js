...
module.exports = {
    ...
    plugins: ['react-hooks', 'prettier', '@typescript-eslint', 'planner'],
    extends: [
        'airbnb',
        'prettier',
    ...
    rules: {
        ...
        // There’re too many cases when using the ConstraintInput is the only option
