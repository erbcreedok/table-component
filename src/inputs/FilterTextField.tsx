/* eslint-disable react-hooks/exhaustive-deps,react/jsx-no-duplicate-props */
import React, {
	ChangeEvent,
	FC,
	MouseEvent,
...
export const FilterTextField: FC<Props> = ({
	header,
	rangeFilterIndex,
	table,
}) => {
	...
	}, [column, handleClear, isRangeFilter, rangeFilterIndex])
